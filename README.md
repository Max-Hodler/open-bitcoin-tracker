...
Open Bitcoin Tracker (OBT) **is not a wallet.** It doesn't send, receive, or hold bitcoin — it's a tracker for people who hold long-term and want to keep an eye on the value of their stacks.

The amount of bitcoin is entered manually, that way no public keys are exposed. Everything is stored on your phone and it's never uploaded anywhere.

It has instant startup and minimal battery impact.
