...
enum _TotalMenuAction { move, hide }
...
List<Widget> lockedStacksBlock() => [
  ...
  Future<void> _showTotalMenu(BuildContext iconContext, AppStateNotifier app) async {
    final atBottom = app.totalCardAtBottom;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                MenuActionTile(
                  leading: Icon(
                    atBottom ? Icons.vertical_align_top : Icons.vertical_align_bottom,
                  ),
                  label: atBottom ? l10n.totalMenuMoveToTop : l10n.totalMenuMoveToBottom,
                  onTap: () => Navigator.of(ctx).pop(_TotalMenuAction.move),
                ),
                const SizedBox(height: AppSpacing.xs),
                MenuActionTile(
                  leading: const Icon(Icons.visibility_off_outlined),
                  label: l10n.totalMenuHide,
                  onTap: () => Navigator.of(ctx).pop(_TotalMenuAction.hide),
                ),
              ],
            ),
          ),
    ...
    switch (action) {
      case _TotalMenuAction.move:
        app.setTotalCardAtBottom(!atBottom);
