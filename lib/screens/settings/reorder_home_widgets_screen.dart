...
class ReorderHomeWidgetsScreen extends StatelessWidget {
  const ReorderHomeWidgetsScreen({super.key});
            ...
            child: ScrollHairline(
              child: ReorderableListView.builder(
                ...
                onReorder: (oldIndex, newIndex) {
                  AppHaptics.medium();
                  app.reorderHomeWidgets(oldIndex, newIndex);
                },
