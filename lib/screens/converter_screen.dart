...
class ConverterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final globalBtcMode = notifier.bitcoinDisplayMode;
  ...
  Future<void> _openBtcUnitPicker(BuildContext context) async {
    ...
    final current =
        notifier.converterBtcMode ?? notifier.bitcoinDisplayMode;
...
/// Pill-shaped segmented control: Fiat-BTC / Sats-BTC.
class _ModeToggle extends StatelessWidget {
  ...
  Widget _segment(
    ...
    return Expanded(
      child: DecoratedBox(
        decoration: BoxDecoration(
          color: selected ? palette.bitcoinOrange : Colors.transparent,
          borderRadius: BorderRadius.circular(999),
        ),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(999),
