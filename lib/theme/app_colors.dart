...
class AppColors {
  ...
  // Light theme — warm cream surfaces with dark brown text.
  static const Color background = Color(0xFFF3EDE2);
  static const Color surface = Color(0xFFFBF6EB);
  static const Color mutedSurface = Color(0xFFEAE1CD);
  ...
  static const Color textPrimary = Color(0xFF2B1F12);
  static const Color textMuted = Color(0xFF7A6A54);

  static const Color divider = Color(0x142B1F12);
